package se.wiklund.colony.handler;
...
public class FileHandler {
	...
	static {
		...
		if (os.contains("WIN")) {
			DIR = System.getenv("APPDATA") + "\\Wiklund PALL\\Colony";
		} else if (os.contains("MAC")) {
			DIR = System.getProperty("user.home") + "/Library/Wiklund PALL/Colony";
		} else {
			DIR = System.getProperty("user.home") + "/Wiklund PALL/Colony";
		}
